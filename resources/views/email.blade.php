    ...
    <body>
        <div class="main">
            <div class="leftSection">
                <div class="logo">
                    <img src="images/HDCwhite.png" alt="HDC Logo" width="250" height="200">
                </div>
                <h1>Contact Us</h1>
            ...
            <form action="{{ route('send.email') }}" class="contact100-form validate-form" method="post" id="contactUs-form">
                ...
                <div class="checkbox">
                    <input id="cb" type="checkbox" name="checkbox" required><span>I agree to the <a href="{{asset('/privacyNotice')}}">Privacy Policy for HDC</a></span>
                </div>
